...
namespace Clockmaker0.Data
{
    ...
    public class ReferenceProperty<T> : INotifyPropertyChanged
    {
        ...
        /// </summary>
        /// <param name="expr">Function that returns a property or field</param>
        ...
        public ReferenceProperty(Expression<Func<T>> expr, INotifyPropertyChanged? propertyChangedObject = null)
        {
            ...
            switch (memberExpression.Member)
            {
                case PropertyInfo propertyInfo:
                {
                    ...
                    _getter = Expression.Lambda<Func<T>>(Expression.Call(instanceExpression, propertyInfo.GetGetMethod() ?? throw new InvalidOperationException())).Compile();
